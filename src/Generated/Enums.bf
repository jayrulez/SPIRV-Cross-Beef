...
[AllowDuplicates, CRepr] public enum SpvSourceLanguage
{
...
[AllowDuplicates, CRepr] public enum SpvExecutionModel
{
...
[AllowDuplicates, CRepr] public enum SpvAddressingModel
{
...
[AllowDuplicates, CRepr] public enum SpvMemoryModel
{
...
[AllowDuplicates, CRepr] public enum SpvExecutionMode
{
...
[AllowDuplicates, CRepr] public enum SpvStorageClass
{
...
[AllowDuplicates, CRepr] public enum SpvDim
{
	SpvDim1D = 0,
	SpvDim2D = 1,
	SpvDim3D = 2,
...
[AllowDuplicates, CRepr] public enum SpvSamplerAddressingMode
{
...
[AllowDuplicates, CRepr] public enum SpvSamplerFilterMode
{
...
[AllowDuplicates, CRepr] public enum SpvImageFormat
{
...
[AllowDuplicates, CRepr] public enum SpvImageChannelOrder
{
...
[AllowDuplicates, CRepr] public enum SpvImageChannelDataType
{
...
[AllowDuplicates, CRepr] public enum SpvImageOperandsShift
{
...
[AllowDuplicates, CRepr] public enum SpvImageOperandsMask
{
...
[AllowDuplicates, CRepr] public enum SpvFPFastMathModeShift
{
...
[AllowDuplicates, CRepr] public enum SpvFPFastMathModeMask
{
...
[AllowDuplicates, CRepr] public enum SpvLinkageType
{
...
[AllowDuplicates, CRepr] public enum SpvAccessQualifier
{
...
[AllowDuplicates, CRepr] public enum SpvFunctionParameterAttribute
{
...
[AllowDuplicates, CRepr] public enum SpvDecoration
{
...
[AllowDuplicates, CRepr] public enum SpvBuiltIn
{
...
[AllowDuplicates, CRepr] public enum SpvSelectionControlShift
{
...
[AllowDuplicates, CRepr] public enum SpvSelectionControlMask
{
...
[AllowDuplicates, CRepr] public enum SpvLoopControlShift
{
...
[AllowDuplicates, CRepr] public enum SpvLoopControlMask
{
...
[AllowDuplicates, CRepr] public enum SpvFunctionControlMask
{
...
[AllowDuplicates, CRepr] public enum SpvMemorySemanticsShift
{
...
[AllowDuplicates, CRepr] public enum SpvMemorySemanticsMask
{
...
[AllowDuplicates, CRepr] public enum SpvMemoryAccessShift
{
...
[AllowDuplicates, CRepr] public enum SpvMemoryAccessMask
{
...
[AllowDuplicates, CRepr] public enum SpvScope
{
...
[AllowDuplicates, CRepr] public enum SpvGroupOperation
{
...
[AllowDuplicates, CRepr] public enum SpvKernelEnqueueFlags
{
...
[AllowDuplicates, CRepr] public enum SpvKernelProfilingInfoShift
{
	SpvKernelProfilingInfoCmdExecTimeShift = 0,
	SpvKernelProfilingInfoMax = 2147483647,
}

[AllowDuplicates, CRepr] public enum SpvKernelProfilingInfoMask
{
	SpvKernelProfilingInfoMaskNone = 0,
	SpvKernelProfilingInfoCmdExecTimeMask = 1,
}

[AllowDuplicates, CRepr] public enum SpvCapability
{
...
[AllowDuplicates, CRepr] public enum SpvRayFlagsShift
{
...
[AllowDuplicates, CRepr] public enum SpvRayFlagsMask
{
	...
	SpvRayFlagsSkipBuiltinPrimitivesNVMask = 256,
...
[AllowDuplicates, CRepr] public enum SpvRayQueryCommittedIntersectionType
{
...
[AllowDuplicates, CRepr] public enum SpvRayQueryCandidateIntersectionType
{
...
[AllowDuplicates, CRepr] public enum SpvFragmentShadingRateShift
{
...
[AllowDuplicates, CRepr] public enum SpvFragmentShadingRateMask
{
...
[AllowDuplicates, CRepr] public enum SpvFPDenormMode
{
...
[AllowDuplicates, CRepr] public enum SpvFPOperationMode
{
...
[AllowDuplicates, CRepr] public enum SpvQuantizationModes
{
...
[AllowDuplicates, CRepr] public enum SpvOverflowModes
{
...
[AllowDuplicates, CRepr] public enum SpvPackedVectorFormat
{
...
[AllowDuplicates, CRepr] public enum SpvTensorOperandsShift
{
...
[AllowDuplicates, CRepr] public enum SpvTensorOperandsMask
{
	SpvTensorOperandsMaskNone = 0,
	SpvTensorOperandsNontemporalARMMask = 1,
	SpvTensorOperandsOutOfBoundsValueARMMask = 2,
	SpvTensorOperandsMakeElementAvailableARMMask = 4,
	SpvTensorOperandsMakeElementVisibleARMMask = 8,
	SpvTensorOperandsNonPrivateElementARMMask = 16,
}
...
[AllowDuplicates, CRepr] public enum SpvMatrixMultiplyAccumulateOperandsShift
{
...
[AllowDuplicates, CRepr] public enum SpvMatrixMultiplyAccumulateOperandsMask
{
	SpvMatrixMultiplyAccumulateOperandsMaskNone = 0,
	SpvMatrixMultiplyAccumulateOperandsMatrixASignedComponentsINTELMask = 1,
	SpvMatrixMultiplyAccumulateOperandsMatrixBSignedComponentsINTELMask = 2,
	SpvMatrixMultiplyAccumulateOperandsMatrixCBFloat16INTELMask = 4,
	SpvMatrixMultiplyAccumulateOperandsMatrixResultBFloat16INTELMask = 8,
	SpvMatrixMultiplyAccumulateOperandsMatrixAPackedInt8INTELMask = 16,
	SpvMatrixMultiplyAccumulateOperandsMatrixBPackedInt8INTELMask = 32,
	SpvMatrixMultiplyAccumulateOperandsMatrixAPackedInt4INTELMask = 64,
	SpvMatrixMultiplyAccumulateOperandsMatrixBPackedInt4INTELMask = 128,
	SpvMatrixMultiplyAccumulateOperandsMatrixATF32INTELMask = 256,
	SpvMatrixMultiplyAccumulateOperandsMatrixBTF32INTELMask = 512,
	SpvMatrixMultiplyAccumulateOperandsMatrixAPackedFloat16INTELMask = 1024,
	SpvMatrixMultiplyAccumulateOperandsMatrixBPackedFloat16INTELMask = 2048,
	SpvMatrixMultiplyAccumulateOperandsMatrixAPackedBFloat16INTELMask = 4096,
	SpvMatrixMultiplyAccumulateOperandsMatrixBPackedBFloat16INTELMask = 8192,
}
...
[AllowDuplicates, CRepr] public enum SpvCooperativeVectorMatrixLayout
{
...
[AllowDuplicates, CRepr] public enum SpvComponentType
{
...
[AllowDuplicates, CRepr] public enum spvc_result
{
	SPVC_SUCCESS = 0,
...
[AllowDuplicates, CRepr] public enum spvc_capture_mode
{
	Copy = 0,
	TakeOwnership = 1,
	IntMax = 2147483647,
...
[AllowDuplicates, CRepr] public enum spvc_backend
{
	None = 0,
	Glsl = 1,
	Hlsl = 2,
...
[AllowDuplicates, CRepr] public enum spvc_resource_type
{
	Unknown = 0,
	UniformBuffer = 1,
	StorageBuffer = 2,
...
[AllowDuplicates, CRepr] public enum spvc_builtin_resource_type
{
	Unknown = 0,
	StageInput = 1,
	StageOutput = 2,
...
[AllowDuplicates, CRepr] public enum spvc_basetype
{
	Unknown = 0,
	Void = 1,
	Boolean = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_platform
{
	Ios = 0,
	Macos = 1,
	MaxInt = 2147483647,
...
[AllowDuplicates, CRepr] public enum spvc_msl_index_type
{
	None = 0,
	Uint16 = 1,
	Uint32 = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_shader_variable_format
{
	Other = 0,
	Uint8 = 1,
	Uint16 = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_shader_variable_rate
{
	PerVertex = 0,
	PerPrimitive = 1,
	PerPatch = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_coord
{
	Normalized = 0,
	Pixel = 1,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_filter
{
	Nearest = 0,
	Linear = 1,
	IntMax = 2147483647,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_mip_filter
{
	None = 0,
	Nearest = 1,
	Linear = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_address
{
	ClampToZero = 0,
	ClampToEdge = 1,
	ClampToBorder = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_compare_func
{
	Never = 0,
	Less = 1,
	LessEqual = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_border_color
{
	TransparentBlack = 0,
	OpaqueBlack = 1,
	OpaqueWhite = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_format_resolution
{
	_444 = 0,
	_422 = 1,
	_420 = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_chroma_location
{
	CositedEven = 0,
	Midpoint = 1,
	IntMax = 2147483647,
...
[AllowDuplicates, CRepr] public enum spvc_msl_component_swizzle
{
	Identity = 0,
	Zero = 1,
	One = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_ycbcr_model_conversion
{
	RgbIdentity = 0,
	YcbcrIdentity = 1,
	YcbcrBt709 = 2,
...
[AllowDuplicates, CRepr] public enum spvc_msl_sampler_ycbcr_range
{
	ItuFull = 0,
	ItuNarrow = 1,
	IntMax = 2147483647,
...
[AllowDuplicates, CRepr] public enum spvc_hlsl_binding_flag_bits
{
...
[AllowDuplicates, CRepr] public enum spvc_compiler_option
{
	Unknown = 0,
